...
rule _picard_qc_alignment_summary:
    ...
    resources:
        **CFG["resources"]["alignment_summary"]
    shell:
        op.as_one_line("""
...
rule _picard_qc_wgs_metrics:
    ...
    group: "picard_qc_genome"
    conda:
        CFG["conda_envs"]["picard"]
    threads:
        CFG["threads"]["wgs_metrics"]
    resources:
        **CFG["resources"]["wgs_metrics"]
    shell:
        op.as_one_line("""
