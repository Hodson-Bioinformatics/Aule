...
def parseNonRef(read):
    ...
    if nonref > 0:
        ...
        discordance = list(read.get_tag("ce"))
        ...
        for pos in aligned: # Example of a pos (70, 105712216, 'A') - position in the read, coordinate, reference base
            ...
            if pos[1] is None and pos[2] is None:
                ...
                if now == last:
                    ...
                    nonref = [chrom, last_pos, ref, alt, ref_orignal, alt_orignal, abs(dist), qual[pos[0]], "I", 0] # Last 0 as placeholder for discordance for now
            ...
            # Deletion
                ...
                nonref = [chrom, pos[1], ref, alt, ref_orignal, alt, abs(dist), 0, "D", 0] # Last 0 as placeholder for discordance for now
            ...
            # Mismatch
                ...
                if read.is_reverse:
                    ...
                    ref_original = pos[2]
                nonref = [chrom, pos[1], ref, alt, ref_original, alt_original, abs(dist), qual[pos[0]], "M", disc]
                idd = "_".join(map(str, [chrom, pos[1], ref, alt]))
                bases.append(nonref)
                ids.append(idd)
                dist += 1
